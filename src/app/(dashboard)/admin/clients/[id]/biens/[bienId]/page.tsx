        ...
        {editBien ? (
          ...
          <div className="grid grid-cols-4 gap-3 text-xs">
            ...
            <div>
              ...
              <p className="text-gray-300">{bien.ville || "-"} {bien.codePostal ? `(${bien.codePostal})` : ""}</p>
            </div>
            <div>
            ...
            {bien.lienAnnonce && (
              <div className="col-span-4 mt-1">
                <p className="text-[10px] text-gray-600">Annonce</p>
                <a href={bien.lienAnnonce} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline text-xs">{bien.lienAnnonce}</a>
              </div>
            )}
          </div>
        )}
